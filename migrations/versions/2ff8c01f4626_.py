...
Revision ID: 2ff8c01f4626
Revises: 4c820712fc98
Create Date: 2020-01-09 14:19:12.382102
...
def upgrade():
    ...
    op.create_index(op.f('ix_notes_modified_by'), 'notes', ['modified_by'], unique=False)
...
def downgrade():
    ...
    op.drop_index(op.f('ix_notes_modified_by'), table_name='notes')
